...
class Multifactor:
    ...
    # facprob supposed to look like: {'Fluency':0.3,'Spatial':0.5,'Reasoning': 0.2}, and additional common factor '*' will always be added
    
        self.facprob = {'*': (0.0,0,Factor())}
        for Name,Prob in facprob.iteritems(): self.facprob[Name] = (Prob,0,Factor()) # for each factor, store <selection-prob>,<n-chosen>,<factor>
    ...
    def nextcat(self): # also UPDATE THE USAGE COUNTS
